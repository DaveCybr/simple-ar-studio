  ...
  const features = [
    {
      ...
      title: "Upload Mudah",
      description:
        "Upload marker dan konten dalam hitungan detik dengan drag & drop",
    },
    {
      icon: Eye,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Upload marker, tambahkan konten video atau gambar, dan langsung
              bagikan pengalaman Augmented Reality Anda ke seluruh dunia.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Platform lengkap untuk membuat, mengelola, dan membagikan konten
              AR
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Upload Marker",
                desc: "Upload gambar yang akan menjadi target scan AR",
              },
              {
                step: "2",
                title: "Tambah Konten",
                desc: "Pilih video atau gambar yang akan muncul di AR",
              },
              {
                step: "3",
                title: "Bagikan!",
                desc: "Scan marker dan bagikan pengalaman AR Anda",
              },
            ].map((item) => (
          ...
          <Card className="max-w-4xl mx-auto bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 border-primary/20">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
                Mulai gratis hari ini dan lihat betapa mudahnya membuat
                pengalaman AR yang menakjubkan.
              </p>
              <Link to="/auth">
